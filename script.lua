--[[ Don't stole my code and adding your credit, atleast use mine ]]--
...
local function teller()
    ...
    title.Text = "scary spelling" --[[ Change your helper name here ]]--
...
local function sendGradualInput(word)
    ...
    for i = startIndex, #word do
        ...
        task.wait(0.1) -- change legit mode delay
    end
